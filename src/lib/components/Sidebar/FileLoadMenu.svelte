    ...
    <div class="card-body p-4">
        ...
        <form>
            <div class="bg-base-200 mb-4 rounded-lg p-3">
                <legend class="flex items-center font-medium">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="mr-2 h-4 w-4"
                        fill="none"
                ...
                <input
                    type="file"
                    class="file-input file-input-sm mt-2 mb-3 w-full"
                    accept=".csv,.tsv"
                    bind:files={$files}
                />
                <div class="mt-3">
                    <label for="encode-select" class="flex items-center font-medium">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="mr-2 h-4 w-4"
                            fill="none"
                    ...
                    <select
                        id="encode-select"
                        class="select select-sm mt-1 w-full text-xs"
                        bind:value={$encode}
                    >
